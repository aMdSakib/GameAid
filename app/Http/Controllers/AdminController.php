...
class AdminController extends Controller
{
    public function AdminDashboard(){
        ...
        $unapprovedCount = $unapprovedExperiences->count();
        return view('admin.admin_dashboard', compact('games', 'news', 'unapprovedExperiences', 'unapprovedCount'));
    } //End Method
    ...
    public function addNewsArticle(Request $request)
    {
        ...
        return redirect()->route('home')->with('success', 'News article added successfully!');
    }
